#!/usr/bin/env python3
"""V1.1 Strategy Portfolio Size Comparison.

Compares V1.1 (VBO+BTC entry, EMA5 exit) across 1-5 asset combinations.
"""
...
def backtest_v1_1(symbols: list[str], start: str | None = None, end: str | None = None) -> dict:
    """V1.1: VBO+BTC entry, EMA5 exit."""
...
def main():
    print("=" * 90)
    print("V1.1 PORTFOLIO SIZE COMPARISON")
    print("V1.1: VBO+BTC entry, EMA5 exit")
    print("=" * 90)
